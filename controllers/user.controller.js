...
exports.signUp = (req, res) => {
    ...
    sendMail ("Inscription site LudicZone", "<h1>LudicZone</h1><p>Ceci est un message.</p><p>Ceci un lien : <a href='http://localhost:3000/'>lien</a>", "ceodrenazerdsq@outlook.com")
        .then((info) => {
